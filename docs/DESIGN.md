...
| TOL-QP-CURV | qp.c:334 | 1e-12·(1+\|Q\|)·p² | V | zero-curvature test (flat-direction ⇒ unbounded/indefinite edge); may never declare curvature where a real positive step exists beyond tol |
