...
| TOL-QP-BOXLADDER | qp.c:681 | {1e9, 1e6, 1e3, 1e12} | C | the box scales tried in turn.  No entry is canonical and none may be promoted to the single value: on ill-conditioned rows one fixed scale is a coin flip (12/16 of the degenerate sweep certified with the ladder, versus 12/16 split across any one scale) |
